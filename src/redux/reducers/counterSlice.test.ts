...
describe('counterSlice', () => {
  ...
  it('should increment counter by 4', async () => {
    ...
    expect(services.logger.info).toHaveBeenNthCalledWith(1, expect.any(String), 'calling api...');

    await promise;
    expect(services.logger.info).toHaveBeenNthCalledWith(2, expect.any(String), 'got result');
